...
- Se agrupo la información de cada AGEB con la de su localidad.
...
- Se transforma las frecuencias simples de delitos a tasas por el número de habitantes de cada AGEB
