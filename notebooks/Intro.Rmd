...
Dados estas restricciones, el problema se resolvió transformando la variable dependiente en una variable categórica binomial que permitiera predecir la existencia de al menos un robo en cada una de las unidades geográficas de la Ciudad de México. Con este modelo se obtuvo los siguientes resultados...
